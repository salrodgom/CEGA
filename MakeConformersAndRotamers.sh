...
mv ../$1 .
echo "0.0" > .CHRG
xtb $1 --charge 0 --opt extreme > Step_00.log
mv xtbopt.xyz $1
crest $1 -chrg 0 -alpb water -entropy > Step_0.log
...
crest crest_best.xyz -cregen crest_conformers.xyz -chrg 0 -alpb water > Step_3.log
echo "
